...
export const logicoolMxMaster4VsMxMaster3sSeed: CommercialArticleSeed = {
  ...
  verifiedRows: [
    ...
    },
    {
      ...
      right: "84.3×124.9×51mm",
      highlight: "right",
      highlightNote: "幅・奥行きが小さい",
    },
    {
      label: "重量",
      left: "150g",
    ...
    { label: "電池寿命", left: "最長70日", right: "最長70日", highlight: null },
    { label: "保証期間", left: "2年", right: "2年", highlight: null },
  ],
  faqEntries: [
    {
      question: "MX Master 4が向いているのはどんな人？",
      answer:
    ...
    {
      question: "軽いのはどちら？",
      answer: "MX Master 3Sです。141gで、MX Master 4より9g軽くなっています。",
    },
    {
      question: "電池持ちは違う？",
      answer: "公式公称値はいずれも最長70日です。",
    },
  ],
  decisionGuideSteps: [
  ...
  socialProofQuery:
    "Logitech MX Master 4 MX2400GR MX Master 3S MX2300GR review",
  sourceLinks: [
    {
      label: "MX Master 4 公式",
      url: "https://www.logicool.co.jp/ja-jp/shop/p/mx-master-4",
